            ...
            <CardContent>
              ...
              <div className='space-y-4'>
                ...
                <p className='text-muted-foreground'>
                  Schedule daily summary reports to be sent automatically via WhatsApp to the garage owner. Reports
                  include pending jobs, completed jobs, revenue summary, and pending payments.
                </p>
                <div className='bg-yellow-50 border-l-4 border-yellow-400 p-4 text-sm text-yellow-800'>
                  <strong>Note:</strong> For scheduled reports to work, the application must be running and connected to
                  the internet. The owner's phone number must have WhatsApp installed.
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='h-[500px] flex items-center justify-center'>
              <div className='text-center'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Track revenue trends, service popularity, and customer growth
                </p>
              </div>
            </CardContent>
          </Card>
